...
import { extend, override } from 'cmf/common/extend';
import TextEditor from 'cmf/common/components/TextEditor';
import BasicEditorDriver from 'cmf/common/utils/BasicEditorDriver';
import styleSelectedText from 'cmf/common/utils/styleSelectedText';
...
function markdownToolbarItems(oldFunc) {
  ...
  function tooltip(name, hotkey) {
    return app.translator.trans(`cmf-markdown.lib.composer.${name}_tooltip`) + (hotkey ? ` <${modifierKey}-${hotkey}>` : '');
  }
